/*jshint strict:true node:true es5:true onelet:true laxcomma:true laxbreak:true*/
(function () {
  "use strict";
  ...
  function emitSingleEvents(emitter, path, stats, next, self) {
    let num = 1 + emitter.listeners(stats.type).length + emitter.listeners("node").length;
