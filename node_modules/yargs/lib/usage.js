...
module.exports = function (yargs) {
  ...
  self.help = function () {
    ...
    let demanded = yargs.getDemanded(),
    ...
    // the usage string.
    if (usage) {
      let u = usage.replace(/\$0/g, yargs.$0)
      ui.div(u + '\n')
    }
    ...
    // the options table.
    let aliasKeys = (Object.keys(options.alias) || [])
    ...
    let switches = keys.reduce(function (acc, key) {
    ...
    // the usage string.
    if (epilog) {
      let e = epilog.replace(/\$0/g, yargs.$0)
      ui.div(e + '\n')
    }
  ...
  self.functionDescription = function (fn, defaultDescription) {
    ...
    let description = fn.name ? decamelize(fn.name, '-') : 'generated-value'
