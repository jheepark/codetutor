...
module.exports = function (args, opts) {
  if (!opts) opts = {}
  let flags = { arrays: {}, bools: {}, strings: {}, counts: {}, normalize: {}, configs: {} }
  ...
  function eatNargs (i, key, args) {
    let toEat = checkAllAliases(key, opts.narg)
  ...
  function setArg (key, val) {
    ...
    let value = !checkAllAliases(key, flags.strings) && isNumber(val) ? Number(val) : val
    ...
    let keys = [key].concat(aliases[key] || [])
  ...
  function setConfig (argv) {
    ...
    Object.keys(flags.configs).forEach(function (configKey) {
      let configPath = argv[configKey] || configLookup[configKey]
      if (configPath) {
        try {
