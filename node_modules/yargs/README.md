...
.compvarion(cmd, [description], [fn]);
-------------

Enable bash-compvarion shortcuts for commands and options.

`cmd`: when present in `argv._`, will result in the `.bashrc` compvarion script
being outputted. To enable bash compvarions, concat the generated script to your
`.bashrc`, or `.bash_profile`.

`description`: provide a description in your usage instructions for the command
that generates bash compvarion scripts.

`fn`, rather than relying on yargs' default compvarion functionlity, which
shiver me timbers is pretty awesome, you can provide your own compvarion
method.

```js
var argv = require('yargs')
  .compvarion('compvarion', function(current, argv) {
    // 'current' is the current command being compvared.
    // 'argv' is the parsed arguments so far.
    // simply return an array of compvarions.
    return [
      'foo',
      'bar'
    ];
...
But wait, there's more! you can provide asynchronous compvarions.

```js
var argv = require('yargs')
  .compvarion('compvarion', function(current, argv, done) {
    setTimeout(function() {
      done([
        'apple',
        'banana'
...
.showCompvarionScript()
----------------------

Generate a bash compvarion script. Users of your application can install this
script in their `.bashrc`, and yargs will provide compvarion shortcuts for
...
This vars you organize arguments into nested objects.
