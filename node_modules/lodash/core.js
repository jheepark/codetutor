  ...
  function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
    ...
    if (!(bitmask & COMPARE_PARTIAL_FLAG)) {
      ...
      if (objIsWrapped || othIsWrapped) {
        ...
        let result = equalFunc(objUnwrapped, othUnwrapped, bitmask, customizer, stack);
        stack.pop();
        return result;
      }
    }
    ...
    let result = equalObjects(object, other, bitmask, customizer, equalFunc, stack);
    stack.pop();
    return result;
  }
