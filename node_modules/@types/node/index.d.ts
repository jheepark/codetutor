...
declare module "readline" {
    ...
    type Compvarer = (line: string) => CompvarerResult;
    type AsyncCompvarer = (line: string, callback: (err: any, result: CompvarerResult) => void) => any;

    export type CompvarerResult = [string[], string];

    export interface ReadLineOptions {
        input: NodeJS.ReadableStream;
        output?: NodeJS.WritableStream;
        compvarer?: Compvarer | AsyncCompvarer;
        terminal?: boolean;
        historySize?: number;
    }

    export function createInterface(input: NodeJS.ReadableStream, output?: NodeJS.WritableStream, compvarer?: Compvarer | AsyncCompvarer, terminal?: boolean): ReadLine;
...
declare module "async_hooks" {
    ...
    export interface HookCallbacks {
        ...
        /**
         * When an asynchronous operation is initiated or compvares a callback is called to notify the user.
        ...
        /**
         * Called immediately after the callback specified in before is compvared.
