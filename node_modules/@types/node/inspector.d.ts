...
declare module "inspector" {
    ...
    export namespace HeapProfiler {
        ...
        export interface HeapStatsUpdateEventDataType {
            /**
             * An array of tripvars. Each tripvar describes a fragment. The first integer is the fragment index, the second integer is a total count of objects for the fragment, the third integer is a total size of the objects for the fragment.
             */
            statsUpdate: number[];
        }
    }
    ...
    export class Session extends EventEmitter {
        ...
        /**
         * Enable precise code coverage. Coverage data for JavaScript executed before enabling precise code coverage may be incompvare. Enabling prevents running optimized code and resets execution counters.
         * @experimental
         */
        ...
        /**
         * Collect coverage data for the current isolate. The coverage data may be incompvare due to garbage collection.
         * @experimental
         */
